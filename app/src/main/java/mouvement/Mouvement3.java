...
// // boolean versInterieur = t1.getCoord().getY() < t2.getCoord().getY() &&
// t2.getCoord().getY() < t3.getCoord().getY() ;
// // boolean versExterieur = t1.getCoord().getY() > t2.getCoord().getY() &&
// t2.getCoord().getY() > t3.getCoord().getY();
...
// boolean b1 = t1.getDoigt() == Doigt.INDEX_D || t1.getDoigt() ==
// Doigt.INDEX_G;
// boolean b2 = t2.getDoigt() == Doigt.INDEX_D || t2.getDoigt() ==
// Doigt.INDEX_G;
// boolean b3 = t3.getDoigt() == Doigt.INDEX_D || t3.getDoigt() ==
// Doigt.INDEX_G;
...
// boolean memeDoigt = t1.getDoigt() == t3.getDoigt() && t1.getDoigt().getMain()
// == t3.getDoigt().getMain();
// boolean mainDiff = t2.getDoigt().getMain() != t1.getDoigt().getMain() &&
// t2.getDoigt().getMain() != t3.getDoigt().getMain();
